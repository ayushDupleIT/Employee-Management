  ...
  return (
    <>
      ...
      <div className='row g-5 g-xl-8'>
        ...
        {/* begin::Col */}
        <div className='col-xl-6'>
          <TablesWidget2 className='mb-5 card-xl-stretch mb-xl-8' />
        </div>
        {/* end::Col */}
      </div>
      {/* end::Row */}
      ...
      <div className='row g-5 g-xl-8'>
        ...
        {/* begin::Col */}
        <div className='col-xl-6'>
          <TablesWidget4 className='mb-5 card-xl-stretch mb-xl-8' />
        </div>
        {/* end::Col */}
      </div>
      {/* end::Row */}
      ...
      <div className='row g-5 g-xl-8'>
        ...
        {/* begin::Col */}
        <div className='col-xl-6'>
          <TablesWidget6 className='mb-5 card-xl-stretch mb-xl-8' />
        </div>
        {/* end::Col */}
      </div>
      {/* end::Row */}
      ...
      <div className='row g-5 g-xl-8'>
        ...
        {/* begin::Col */}
        <div className='col-xl-6'>
          <TablesWidget8 className='mb-5 card-xl-stretch mb-xl-8' />
        </div>
        {/* end::Col */}
      </div>
      {/* end::Row */}
